							...
							<ul class="list-main">
								...
								<li>
									<i class="ti-world">
										...
										@if ($localCode == LaravelLocalization::getCurrentLocale())
										<strong>{{ $properties['native'] }}</strong>
										@else
										<a href="{{ route('locale.switch',$localCode) }}" >{{ $properties['native'] }}</a>
										@endif
								...
								<li><i class="ti-power-off"></i><a href="login.html#">{{ __('website.login') }}</a></li>
							</ul>
						</div>
						<!-- End Top Right -->
					</div>
