                                ...
                                <li>
                                    <i class="ti-world">
                                        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                            ...
                                            @else
                                                <a
                                                    href="{{ route('local.switch', $localeCode) }}">{{ $properties['native'] }}</a>
                                            @endif
                                        @endforeach
                                    </i>
                                </li>
                                @auth
                                    <li><i class="ti-user"> <a
                                                href="{{ route('user.dashboard') }}">{{ Auth::user()->name }}</a> </i>
                                    </li>
                                @else
                                    <li><i class="ti-user"><a
                                                href="{{ route('login') }}">{{ __('website.login') }}</a></i></li>
                                    <li><i class="ti-power-off"><a
                                                href="{{ route('register') }}">{{ __('website.register') }}</a></i></li>
                                @endauth
                        ...
                        <div class="col-lg-3">
                            <div class="all-category">
                                <h3 class="cat-heading"><i class="fa fa-bars"
                                        aria-hidden="true"></i>{{ __('website.all_category') }}</h3>
